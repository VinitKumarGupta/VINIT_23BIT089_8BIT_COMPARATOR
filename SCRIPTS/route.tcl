...
# OUTPUTS
##########################################################################
write_verilog ./results/comp_8bit.routed.v
write_sdc -output ./results/comp_8bit.routed.sdc
write_parasitics -format spef -output ./results/comp_8bit_${scenario1}.spef
###########################################################################
